...
AI-powered traffic prediction system using machine learning for traffic classification and route analysis.
**Tech:** Python, TensorFlow, Flask, Pandas, NumPy, Scikit-learn

### 💊 SmartMediCare (Ongoing)
AI-powered medicine assistance app for visually impaired users with OCR, voice guidance, reminders, and expiry alerts.
**Tech:** Flutter, Firebase, Python, OpenCV, OCR, NLP

### 🎓 Student Performance Prediction
Responsive web application for predicting student performance with an interactive user interface.
**Tech:** React, TypeScript, Vite, TanStack Start

### 📊 COVID-19 Analytics Dashboard
Interactive dashboard for exploring global and regional COVID-19 trends through real-time statistics and dynamic visualizations.
**Tech:** React, JavaScript, Chart.js, REST APIs

### 🛡️ Spring Boot Real-Time Fraud Detection
Real-time fraud detection system with live transaction monitoring using WebSockets and interactive analytics.
**Tech:** Spring Boot, Java, WebSockets, Chart.js
## 🎓 Education
